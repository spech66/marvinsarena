...
namespace BattleEngine3D
{
    ...
    public class ArcBallCamera
    {
        ...
        public Matrix ViewMatrix
        {
            get
            {
                return Matrix.CreateLookAt(Target -
                    (Direction * Distance), Target, Up);
            }
        }
        ...
        public ArcBallCameraMode ControlMode
        {
            ...
            set
            {
                ...
                {
                    mode = value;
                    SetCamera(Target - (Direction* Distance),
                              Target, Vector3.Up);
                }
            }
        }
        ...
        public Vector3 Position
        {
            ...
            set
            {
                SetCamera(value, Target, Vector3.Up);
            }
        }
        #endregion
        ...
        public void OrbitUp(float angle)
        {
            ...
            switch (mode)
            {
                ...
                case ArcBallCameraMode.RollConstrained:
					...
					// Fix - Don't allow view from bottom // TODO: need more improvements
            ...
            GameTime gameTime)
        {
            ...
            Distance += ReadKeyboardAxis(kbState, Keys.Q, Keys.E)
                * InputDistanceRate * elapsedTime;
